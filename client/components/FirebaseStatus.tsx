    ...
    return (
      <Alert className="border-orange-200 bg-orange-50 text-orange-800">
        ...
        <AlertDescription className="space-y-3">
          <p>Les permissions Firestore doivent être configurées dans la console Firebase.</p>
          <div className="space-y-2">
            <p className="font-medium">Instructions :</p>
            <ol className="list-decimal list-inside space-y-1 text-sm">
              <li>Accédez à la <a href="https://console.firebase.google.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-orange-900">Console Firebase</a></li>
    ...
    match /{document=**} {
      allow read, write: if true;
            ...
            <Button
              ...
              size="sm"
              className="mt-2"
              onClick={() => window.open('https://console.firebase.google.com/project/keysystem-d0b86/firestore/rules', '_blank')}
            >
              <ExternalLink className="h-3 w-3 mr-1" />
              Ouvrir les règles Firestore
            </Button>
          </div>
          <p className="text-sm">💾 En attendant, l'application fonctionne en mode local.</p>
        </AlertDescription>
      </Alert>
    );
  }
