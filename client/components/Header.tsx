...
export default function Header() {
  ...
  const { maintenanceState, isOnline: maintenanceOnline } =
  ...
  const { effectiveDisplayName, forceSync } = useGlobalDisplayName();
                ...
                <>
                  ...
                  {!isAuthenticated && anonymousUser && (
                    ...
                    >
                      ...
                      {(isUserBanned(anonymousUser.id).isBanned ||
                        anonymousUser.isBanned) && (
                        ...
                        anonymousUser?.isLoggedIn && (
                          <div className="flex items-center space-x-2">
                            <DisplayNameEditor
                              ...
                              currentDisplayName={
                                anonymousUserAccount?.profile?.displayName
                              }
